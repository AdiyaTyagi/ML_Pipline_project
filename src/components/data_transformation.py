    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            for col in numerical_features:
                self.remove_outliers_IOR(col = col, df = train_data)
            
            logging.info("outliers capped on our train data")

            for col in numerical_features:
                self.remove_outliers_IOR(col = col, df = test_data)
            ...
            logging.info("Splitting teat data into dependent and independent features")
